...
import { Email, Login, OK } from '../types/auth.type'
...
export async function loginAction(
    ...
    try {
        const response = await httpClient.post<Email>(server.login, payload)
        ...
        if (axios.isAxiosError(error) && error.response) {
            ...
            return {
                ...
                message: 'Not found username.', // ใช้ข้อความจากข้อมูลข้อผิดพลาด
                errors: [
                    {
                        path: 'server',
