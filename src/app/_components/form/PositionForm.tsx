            ...
            <Stack spacing={2} direction={'row'}>
                    ...
                    <Autocomplete
                        ...
                        renderInput={params => (
                            <TextField
                                ...
                                size='small'
                                error={!!errors.symbol}
                                helperText={!!errors.symbol ? 'Please select a symbol.' : ''}
                            />
                        )}
                    />
                </Box>
                <Box>
                    ...
                    <TextField
                        ...
                        helperText={!!errors.quantity ? 'Please enter the size.' : (watch('quantity') < 15 ? 'Must be at least 15' : '')}
                        className='w-40'
                        type='number'
                        size='small'
                        {...register('quantity', {
                    ...
                    <Autocomplete
                        ...
                        renderInput={params => (
                            <TextField
                                ...
                                helperText={!!errors.timeframe ? 'Please select a timeframe.' : ''}
                            />
                        )}
                    />
                </Box>
