    ...
    return (
        ...
        >
            ...
            <Box className='flex flex-col justify-center mx-auto'>
                <Typography
                    className={`${+123123 >= 0 ? 'text-LONG' : 'text-SHORT'}`}
                >
                    {(+123123).toFixed(2)} USDT
                </Typography>
                <Typography
                    className={`mx-auto ${
                        +123123 >= 0 ? 'text-LONG' : 'text-SHORT'
                    }`}
                >
                    ({123123})
                </Typography>
            </Box>
            <Box className='flex justify-center'>{'5m'}</Box>
            <Box className='flex justify-center'>{'22/04/2024'}</Box>
            <Box className='flex justify-center'>{`EMA/15`}</Box>
